        ...
        <div className={`${styles.container} ${styles.clearfix}`}>
          <div className={styles.homepageTitle}>
            ...
            <h2 className={styles.profileDesc}>
              {" "}
              A front-end Web Developer <FontAwesomeIcon icon={faLaptopCode} />
            </h2>
          </div>
          ...
          <div className={styles.introBlock}>
            <div className="container clearfix">
              <div className={styles.introParagraph}>
                <p>
                  Hi, I&apos;m <b>Aviral</b>, a self-motivated Tech Enthusiast.
                </p>
                <p>
                  I am a front-end software developer with experience of
                  building web and mobile applications using a variety of tools
                  and have exposure to the entire gamut of software development
                  lifecycle working on areas ranging all the way from data
                  modelling to UI design and release management
                </p>
